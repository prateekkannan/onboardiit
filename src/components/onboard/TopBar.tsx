...
export const TopBar = () => {
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-[600] flex justify-start px-4 pt-4">
      <div className="pointer-events-auto flex animate-fade-in items-center gap-2 rounded-full border border-black/10 bg-white/90 px-3 py-1.5 shadow-sm backdrop-blur">
