...
export const NEARBY: Record<string, Landmark[]> = {
  ...
  "oat": [
    ...
    D("Department of Applied Mechanics and Biomedical Engineering", 3),
  ...
  "edb": [
    ...
    D("Department of Management Studies", 2),
    D("Centre for Entrepreneurship Tinkering and Innovation CETI", 2),
    D("Department of Applied Chemistry", 3),
    D("GFRG Building", 3),
    D("Composites Technology Centre", 3),
    D("Rocket and Missile Lab", 4),
  ],
  "velachery": [
